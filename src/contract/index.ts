...
/**
 * Checks if an object implements the Treaty contract.
 * @param obj - Object to check
 * @returns true if object has the contract symbol set to true
 */
export const isContract = (obj: unknown): boolean => {
  return (
    typeof obj === "object" &&
    obj !== null &&
